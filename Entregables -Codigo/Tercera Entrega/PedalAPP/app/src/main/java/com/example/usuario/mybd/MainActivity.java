        ...
        public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
            ...
            if (user != null) {
                ...
                if(displayName2.length() > 5 &&  displayName2.substring(0,5).equals("-emp-")) {
                    ...
                    Intent i = new Intent(MainActivity.this, Usuario_Empresarial.class);
                    startActivity(i);
                }
                 else    startActivity(new Intent(MainActivity.this, LocalizacionUser.class));
            }
...
//                    Toast.makeText(getBaseContext(),"Logeando: "+user.getDisplayName(),Toast.LENGTH_SHORT).show();
